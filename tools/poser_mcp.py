...
TOOLS = [
    ...
    ("poser_gazepoint", "Edit a gaze point through the same gesture/history route as the UI. Send commit=1 on the final sample.",
     {"actor": "name or index", "x": "world X", "y": "world Y", "z": "world Z", "part": "None (shared anchor), Eyes, Head, or Body", "commit": "1 to seal the gesture"}),
