...
TOOLS = [
    ...
    ("poser_scene", "Read scene progress. Supply a path to add a scene; never clears existing entities. With save=1, save to a new file through production capture instead, without packaging mods or overwriting files.",
     {"path": "optional absolute scene path", "placement": "optional AsSaved, InFrontOfCamera, RelativeToSelectedActor, or RelativeToCamera", "save": "1 to save instead of load", "onlyActor": "optional actor name or index for a single-actor save"}),
    ...
    ("poser_cameras", "Read current camera values without mutating cameras or saving scene files.", {}),
    ...
    ("poser_gazepoint", "Apply one committed gaze point edit through application history. This is not a held-mouse drag simulation.",
     {"actor": "name or index", "x": "world X", "y": "world Y", "z": "world Z", "part": "None (shared anchor), Eyes, Head, or Body"}),
