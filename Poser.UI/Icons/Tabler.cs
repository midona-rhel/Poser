...
public static class Tabler
{
    ...
    public static string NameFor(TablerIcon icon) => icon switch
    {
        ...
        TablerIcon.Eraser          => "eraser",
        TablerIcon.Shirt           => "shirt",
        TablerIcon.Crown           => "crown",
        TablerIcon.Ghost           => "ghost",
        TablerIcon.Wand            => "wand",
        TablerIcon.GenderMale      => "gender-male",
        TablerIcon.GenderFemale    => "gender-female",
