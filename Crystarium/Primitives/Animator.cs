...
internal static class Animator
{
    ...
    public static ElementStyle Step(string? id, in ElementStyle target, in Transition transition)
    {
        ...
        {
            // First frame for this id — snap to target, no animation.
            s = new State
            {
        ...
        float t = ApplyEasing(linearT, transition.Ease);
    ...
    private static float ApplyEasing(float t, Easing e) => e switch
    {
