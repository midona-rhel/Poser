...
/// from Brio's <c>Files/Converters/AnamnesisBoneNameConverter.cs</c> (clone 4c7654a,
/// 161 entries) — the previous inline table had ~31 entries with several
/// WRONG mappings (e.g. EyelidLowerLeft → j_f_mayu_l, which is an eyebrow).
...
public static class AnamnesisBoneNameConverter
{
    ...
    public static string ToGame(string name)
        => AnamnesisToGameMap.TryGetValue(name, out var gameName) ? gameName : name;
}
