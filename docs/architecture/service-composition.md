...
Plugin startup resolves configuration and `IUIManager`, registers the command,
and initializes the UI font/theme bridge. Autosave, public IPC, web API,
projects, libraries, and other deferred features are not eagerly started.
